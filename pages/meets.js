        ...
        <div className={props.theme ? styles.dropdownContainer_light : styles.dropdownContainer}>
          ...
          >
            ...
            <Dropdown.Menu style={{ "background-color": "#070707" }}>
              ...
              <Dropdown.Item>
                <button className={styles.filterButton} onClick={() => setfilter("Technical")}>
                  Technical
                </button>
              </Dropdown.Item>
              <Dropdown.Item>
                <button className={styles.filterButton} onClick={() => setfilter("Finance")}>
                  Finance
                </button>
              </Dropdown.Item>
              <Dropdown.Item>
                <button className={styles.filterButton} onClick={() => setfilter("Design and Marketing")}>
                  Design and Marketing
                </button>
              </Dropdown.Item>
              <Dropdown.Item>
                <button className={styles.filterButton} onClick={() => setfilter("Management")}>
                  Management
                </button>
              </Dropdown.Item>
            </Dropdown.Menu>
